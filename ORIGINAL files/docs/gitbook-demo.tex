...
\pandocbounded{\includegraphics[keepaspectratio]{./img/using_gitbook.jpeg}}
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/settings.png}}
\item
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/new_repo.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/from_template.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/new_project.png}}
\item
  In the next dialog window, you should copy the URL of the GitHub repository you created in \emph{Step 5}, like so:\\
  \pandocbounded{\includegraphics[keepaspectratio]{./img/new_git_project.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/files_editor.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/commit_push.png}}
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/build_book.png}}
\item
...
\item
  ...
  \pandocbounded{\includegraphics[keepaspectratio]{./img/pages_published.png}}
\end{enumerate}
