...
\chapter{Types of input}\label{types-of-input}
...
\chapter{Generate fictional data}\label{generate-fictional-data}
...
\chapter{Obtain input \& output for GORICA}\label{obtain-input-output-for-gorica}
...
\subsection{fit object}\label{fit-object}
...
\subsection{extract estimates}\label{extract-estimates}
...
\subsection{fit object}\label{fit-object-1}
...
\subsection{extract estimates}\label{extract-estimates-1}
...
\section{lmer / lme4}\label{lmer-lme4}
...
\subsection{fit object}\label{fit-object-2}
...
\subsection{extract estimates}\label{extract-estimates-2}
